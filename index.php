              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Add Customer</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Loan Complete</span>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-left">Tushar Ahmed</span>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      ...
                      <a class="users-list-name" href="#">Tushar</a>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Good Customer</h3>
